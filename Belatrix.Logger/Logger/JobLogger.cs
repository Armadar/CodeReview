...
namespace Belatrix
{
    public class JobLogger
    {
        ...
        public JobLogger(IList<LogDestiny> destiny, LogMode? mode)
        {
        ...
        public bool validateLogMode(LogMode? mode, LogMessageType type)
        {
            bool r = true;
            switch (mode)
            {
        ...
        private void lc_onChange(ConsoleColor color, string messageType)
        {
